package org.crashxun.player.activities;
/*
...
import org.crashxun.player.xunxun.subtitle.XSubtitleController;
                    ...
                    case Constant.ACTION_SUBTITLE_CHANGED:
                        ...
                        if (id.equals("off")) {
                            ...
                            if (type.equals(Constant.VALUE_PARAMS_SUBTITLE_TYPE_INTERNAL)) {
                                ...
                                String path = id;
                                mSubtitleController.switchSubtitle(path);
                            }
...
//                        Log.d(TAG, "menuEventReceiver----selectedSubtitleTrack:" + selectedSubtitleTrack);
                    ...
                    case Constant.ACTION_SUBTITLE_TIME_ADJUST:
                        intent = new Intent(context, SubtitleAdjustTimeActivity.class);
                        intent.putExtra(SubtitleAdjustTimeActivity.TIME_PARAMS,mSubtitleController.getTimeAjust());
                        context.startActivity(intent);
                        break;
                }
            }
